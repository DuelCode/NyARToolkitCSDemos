...
namespace jp.nyatla.nyartoolkit.cs.markersystem
{
    ...
    public class NyARMarkerSystem : NyARSingleCameraSystem
    {
         ...
         */
        [System.Obsolete("use getPlaneImage")]
        public INyARRgbRaster getMarkerPlaneImage(int i_id, NyARSensor i_sensor, double i_l, double i_t, double i_w, double i_h, INyARRgbRaster i_raster)
        {
         ...
         * @deprecated
         */
        [System.Obsolete("use getMarkerMatrix")]
         ...
         * @deprecated
         */
        [System.Obsolete("use getVertex2D")]
